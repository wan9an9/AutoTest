...
import test.chnlp.distance.Word2VecSimi;
import test.chnlp.parser.DependencyParser;
import test.chnlp.seg.NERTerm;
import test.chnlp.seg.Segment;
import test.chnlp.summary.TextRankKeyword;
import test.chnlp.summary.TextRankSentence;
...
public class AHANLP {
    ...
    public static List<NERTerm> NER(String content) {
        return test.chnlp.seg.NER.namedEntityRecognition(content);
    }
