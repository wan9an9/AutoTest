...
public class SummaryDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(AHANLP.extractSummary(document, 50000));
        System.out.println("s1 | s3 : " + AHANLP.sentenceSimilarity("NLP", AHANLP.extractSummary(document, 50), document));
